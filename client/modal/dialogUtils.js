...
function dialogUtils(ModalService, $http) {
    ...
    dialogUtils.addApi = function (callback) {
        function addAPiCtrl($scope, $http, close) {
            ...
            this.onOkButtonClicked = function () {
                ...
                $http.post('/api/apiInsight', $scope.api)
        ...
        ModalService.showModal({
            templateUrl: 'modal/api-modal/add-api-modal.html',
    ...
    dialogUtils.editApi = function (api_id, callback) {
        function editApiCtrl($scope, $http, close) {
            $scope.api = {};
            $scope.data = [];
            $scope.api = {};
            $scope.data = [];
            ...
            $http.get('/api/apiInsight/' + api_id)
                .then(function successCallback(data) {
                    ...
                    $scope.response = JSON.parse(data.data.response);
            ...
            this.onOkButtonClicked = function () {
                ...
                $http.put('/api/apiInsight/' + api_id, $scope.api)
                    .then(function successCallback(data) {
                        $scope.api = {};
                        $scope.data = data.data;
                    },
        ...
        ModalService.showModal({
            templateUrl: 'modal/api-modal/edit-api-modal.html',

angular
    .module('myApp')
    .service('dialogApiSOM', dialogUtils);
...
function dialogUtils(ModalService, $http) {
    ...
    dialogUtils.editApi = function (apiSOM_id, callback) {
        function editApiCtrl($scope, $http, $window, close) {
            ...
            $http.get('/apiSOM/' + apiSOM_id)
                .then(function successCallback(data) {
                    ...
                    // if (data.data.payloadParams != "{}") $scope.payloadParams = JSON.parse(data.data.payloadParams);
                    // else $scope.payloadParams = data.data.payloadParams;
                    // if (data.data.samplePayload != "{}") $scope.samplePayload = JSON.parse(data.data.samplePayload);
                    // else $scope.samplePayload = data.data.samplePayload;
            ...
            this.onOkButtonClicked = function () {
                ...
                $http.put('/apiSOM/' + apiSOM_id, $scope.api)
                    .then(function successCallback(data) {
                        $scope.api = {};
                        $scope.data = data.data;
                    },
